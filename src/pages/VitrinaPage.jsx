...
export default function VitrinaPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fdfafb] pb-24 font-sans text-gray-800">
      <nav className="bg-[#f472b6] text-white p-4 text-center sticky top-0 z-50 shadow-md">
      ...
      <main className="max-w-md mx-auto p-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          {productos.map(p => (
            <div key={p.id} className="cute-card flex flex-col items-center p-4">
              ...
              <p className="text-[11px] font-black text-[#f472b6] mt-1">${p.price}</p>
